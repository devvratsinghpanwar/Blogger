...
export const MobileNavToggle = ({
  ...
  return isOpen ? (
    <IconX className="text-[#b66be9] dark:text-white" onClick={onClick} />
  ) : (
    <IconMenu2 className="text-[#b66be9] dark:text-white" onClick={onClick} />
  );
};
  ...
  return (
    ...
    >
      <img
        ...
        height={30}
      />
      <span className="font-medium text-[#b66be9] dark:text-white">Blogger</span>
    </a>
  );
};
